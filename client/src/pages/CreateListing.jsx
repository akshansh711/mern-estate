...
const CreateListing = () => {
    ...
    const handleImageSubmit = (e) => {
         ...
         if(files.length > 0 && files.length + formData.imageUrls.length < 7) {
            ...
            Promise.all(promises).then((urls) => {
                ...
                setImageUploadError('Image upload failes(file should not be more than 2mb')
                setUpLoading(false);
            })
    ...
    const storeImage = async(file) => {
        ...
        return new Promise((resolve, reject) => {
            ...
            uploadTask.on(     // it is as it is available on firebase upload docs.
                "state_changed",
                (snapshot) => {
                    const progress = 
    ...
    const handleSubmit = async(e) => {
        ...
        try {
            ...
            }if(+formData.regularPrice < +formData.discountPrice) {     // the plus sign is added to convert the string into a number.
    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            ...
            <div className='flex flex-col flex-1 gap-4'>
                ...
                hover:opacity-95 disabled:opacity-80 hover:shadow-lg'>{loading ? 'Creating...' : 'create listing'}</button>

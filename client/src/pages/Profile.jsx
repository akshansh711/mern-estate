...
import { deleteUserFailure, updateUserSuccess, updateUserFailure, updateUserStart, deleteUserStart, deleteUserSuccess, signOutUserStart } from '../redux/user/userSlice';
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <img onClick={()=>fileRef.current.click()} src={formData.avatar || currentUser.avatar} alt='avatar-img'
        ...
        <input onChange={handleChange} type='email' placeholder='username' id='email'
        className='border p-3 rounded-lg' defaultValue={currentUser.email}/>
        <input type='password' placeholder='password' id='password'
        className='border p-3 rounded-lg' />
        <button disabled={loading} className='bg-slate-700 text-w=white rounded-lg
        p-3 uppercase hover:opacity-95 disabled:opacity-85'>{loading? 'Loading...': 'Update'}</button>
